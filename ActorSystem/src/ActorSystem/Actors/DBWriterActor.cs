...
public class DBWriterActor : ActorBase
{
    ...
    public DBWriterActor(IMessageSystem messageSystem, IMailBox mailBox,string ID,IMongoCollection<BsonDocument> collection, params string[] keys) : base(messageSystem, mailBox, ID)
    {
